...
// console.log(getCarsToBuyByModelAndAgencyId(ourCarMarket.sellers, "3"));
...
// console.log(ourCarMarket.customers);
//! ---------------- Setters -----------------
...
// console.log(setNewCarToAgency(ourCarMarket.sellers[0], { tesla: [{}] }));
...
const deleteCarFromAgency = (agencyObject, carNumber) => {
  for (let brand in agencyObject.cars) {
    for (let car of agencyObject.cars[brand]) {
      if (car.carNumber === carNumber) {
        let index = agencyObject.cars[brand].indexOf(car);
        agencyObject.cars[brand].splice(index, 1);
      }
    }
  }
  return agencyObject;
...
// console.log(ourCarMarket.sellers[0].cars.Alpha_Romeo);
// console.log(ourCarMarket.sellers);
...
// console.log(decOrIncCashOfAgency(ourCarMarket.sellers[0], 15000000));
...
const decOrIncCreditOfAgency = (agencyObj, amount) => {
  const newCredit = agencyObj.credit - amount;
  return newCredit > 0 ? (agencyObj.credit = newCredit) : agencyObj.credit;
};
// console.log(decOrIncCreditOfAgency(ourCarMarket.sellers[0], 10000));
...
const setCarToCustomer = (customerObj, carObject) => {
  return Object.assign(customerObj.cars, carObject);
};
// console.log(setCarToCustomer(ourCarMarket.sellers[0], { Tesla: [{}] }));
//* 18. deleteCarOfCostumer
//? @param {object} - customerObj
//? @param {string} - carNumber
//? @return {object[]} - allCarsOfCostumer
const deleteCarOfCostumer = (costumerObj, carNumber) => {
  for (let car of costumerObj.cars) {
    if (car.carNumber === carNumber) {
      let index = costumerObj.cars.indexOf(car);
...
// console.log(deleteCarOfCostumer(ourCarMarket.customers[1], "RLS4q"));
...
const decOrIncCashOfCustomer = (costumerObj, amount) => {
  const newCash = costumerObj.cash - amount;
  return newCash > 0 ? (costumerObj.cash = newCash) : costumerObj.cash;
};
// console.log(decOrIncCashOfCustomer(ourCarMarket.customers[0], 1000));
//! ---------------- Hard ----------------------
